...
public class CoreKernel {
    ...
    public static Direction getDirFromVector(Vector2 vector) {
        return PhysicEngine.getDirFromVector(vector);
    }
    ...
    public static void playSfxOnLoop(String path) {
        SoundEngine.playSfxOnLoop(path);
    }
